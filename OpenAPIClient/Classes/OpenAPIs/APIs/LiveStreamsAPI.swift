...
open class LiveStreamsAPI {
    ...
    open class func youtubeLiveStreamsInsertWithRequestBuilder(part: [String], xgafv: Xgafv_youtubeLiveStreamsInsert? = nil, accessToken: String? = nil, alt: Alt_youtubeLiveStreamsInsert? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, onBehalfOfContentOwner: String? = nil, onBehalfOfContentOwnerChannel: String? = nil, liveStream: LiveStream? = nil) -> RequestBuilder<LiveStream> {
        ...
        let requestBuilder: RequestBuilder<LiveStream>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func youtubeLiveStreamsListWithRequestBuilder(part: [String], xgafv: Xgafv_youtubeLiveStreamsList? = nil, accessToken: String? = nil, alt: Alt_youtubeLiveStreamsList? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, id: [String]? = nil, maxResults: Int? = nil, mine: Bool? = nil, onBehalfOfContentOwner: String? = nil, onBehalfOfContentOwnerChannel: String? = nil, pageToken: String? = nil) -> RequestBuilder<LiveStreamListResponse> {
        ...
        let requestBuilder: RequestBuilder<LiveStreamListResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
