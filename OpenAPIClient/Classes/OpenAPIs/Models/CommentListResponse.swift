...
public struct CommentListResponse: Codable, Hashable {
    ...
    public init(etag: String? = nil, eventId: String? = nil, items: [Comment]? = nil, kind: String? = "youtube#commentListResponse", nextPageToken: String? = nil, pageInfo: PageInfo? = nil, tokenPagination: AnyCodable? = nil, visitorId: String? = nil) {
        self.etag = etag
