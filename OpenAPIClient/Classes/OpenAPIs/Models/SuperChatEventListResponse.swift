//
// SuperChatEventListResponse.swift
//
...
public struct SuperChatEventListResponse: Codable, Hashable {
    ...
    public var kind: String? = "youtube#superChatEventListResponse"
    ...
    public init(etag: String? = nil, eventId: String? = nil, items: [SuperChatEvent]? = nil, kind: String? = "youtube#superChatEventListResponse", nextPageToken: String? = nil, pageInfo: PageInfo? = nil, tokenPagination: AnyCodable? = nil, visitorId: String? = nil) {
        self.etag = etag
