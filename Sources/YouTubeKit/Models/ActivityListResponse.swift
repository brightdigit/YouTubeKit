...
public struct ActivityListResponse: Codable, Hashable {
    ...
    public init(etag: String? = nil, eventId: String? = nil, items: [Activity]? = nil, kind: String? = "youtube#activityListResponse", nextPageToken: String? = nil, pageInfo: PageInfo? = nil, prevPageToken: String? = nil, tokenPagination: AnyCodable? = nil, visitorId: String? = nil) {
        self.etag = etag
