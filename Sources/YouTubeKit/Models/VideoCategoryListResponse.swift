//
// VideoCategoryListResponse.swift
//
...
public struct VideoCategoryListResponse: Codable, Hashable {
    ...
    public init(etag: String? = nil, eventId: String? = nil, items: [VideoCategory]? = nil, kind: String? = "youtube#videoCategoryListResponse", nextPageToken: String? = nil, pageInfo: PageInfo? = nil, prevPageToken: String? = nil, tokenPagination: AnyCodable? = nil, visitorId: String? = nil) {
        self.etag = etag
