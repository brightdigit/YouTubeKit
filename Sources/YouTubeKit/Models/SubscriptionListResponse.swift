...
public struct SubscriptionListResponse: Codable, Hashable {
    ...
    public init(etag: String? = nil, eventId: String? = nil, items: [Subscription]? = nil, kind: String? = "youtube#subscriptionListResponse", nextPageToken: String? = nil, pageInfo: PageInfo? = nil, prevPageToken: String? = nil, tokenPagination: AnyCodable? = nil, visitorId: String? = nil) {
        self.etag = etag
