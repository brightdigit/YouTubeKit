//
// CommentThreadListResponse.swift
//
...
public struct CommentThreadListResponse: Codable, Hashable {
    ...
    public init(etag: String? = nil, eventId: String? = nil, items: [CommentThread]? = nil, kind: String? = "youtube#commentThreadListResponse", nextPageToken: String? = nil, pageInfo: PageInfo? = nil, tokenPagination: AnyCodable? = nil, visitorId: String? = nil) {
        self.etag = etag
