...
open class ChannelBannersAPI {
    ...
    open class func youtubeChannelBannersInsertWithRequestBuilder(xgafv: Xgafv_youtubeChannelBannersInsert? = nil, accessToken: String? = nil, alt: Alt_youtubeChannelBannersInsert? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, channelId: String? = nil, onBehalfOfContentOwner: String? = nil, onBehalfOfContentOwnerChannel: String? = nil, channelBannerResource: ChannelBannerResource? = nil) -> RequestBuilder<ChannelBannerResource> {
        ...
        let requestBuilder: RequestBuilder<ChannelBannerResource>.Type = YouTubeKitAPI.requestBuilderFactory.getBuilder()
