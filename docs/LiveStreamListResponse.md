...
**items** | [LiveStream] | A list of live streams that match the request criteria. | [optional] 
**kind** | **String** | Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#liveStreamListResponse\&quot;. | [optional] [default to "youtube#liveStreamListResponse"]
