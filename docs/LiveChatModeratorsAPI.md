...
```swift
    open class func youtubeLiveChatModeratorsDelete(id: String, xgafv: Xgafv_youtubeLiveChatModeratorsDelete? = nil, accessToken: String? = nil, alt: Alt_youtubeLiveChatModeratorsDelete? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
LiveChatModeratorsAPI.youtubeLiveChatModeratorsDelete(id: id, xgafv: xgafv, accessToken: accessToken, alt: alt, callback: callback, fields: fields, key: key, oauthToken: oauthToken, prettyPrint: prettyPrint, quotaUser: quotaUser, uploadProtocol: uploadProtocol, uploadType: uploadType) { (response, error) in
...
```swift
    open class func youtubeLiveChatModeratorsInsert(part: [String], xgafv: Xgafv_youtubeLiveChatModeratorsInsert? = nil, accessToken: String? = nil, alt: Alt_youtubeLiveChatModeratorsInsert? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, liveChatModerator: LiveChatModerator? = nil, completion: @escaping (_ data: LiveChatModerator?, _ error: Error?) -> Void)
```
...
let uploadProtocol = "uploadProtocol_example" // String | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
let uploadType = "uploadType_example" // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
let liveChatModerator = LiveChatModerator(etag: "etag_example", id: "id_example", kind: "kind_example", snippet: LiveChatModeratorSnippet(liveChatId: "liveChatId_example", moderatorDetails: ChannelProfileDetails(channelId: "channelId_example", channelUrl: "channelUrl_example", displayName: "displayName_example", profileImageUrl: "profileImageUrl_example"))) // LiveChatModerator |  (optional)

LiveChatModeratorsAPI.youtubeLiveChatModeratorsInsert(part: part, xgafv: xgafv, accessToken: accessToken, alt: alt, callback: callback, fields: fields, key: key, oauthToken: oauthToken, prettyPrint: prettyPrint, quotaUser: quotaUser, uploadProtocol: uploadProtocol, uploadType: uploadType, liveChatModerator: liveChatModerator) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **part** | [**[String]**](String.md) | The *part* parameter serves two purposes in this operation. It identifies the properties that the write operation will set as well as the properties that the API response returns. Set the parameter value to snippet. | 
 **xgafv** | **String** | V1 error format. | [optional] 
 **accessToken** | **String** | OAuth access token. | [optional] 
 **alt** | **String** | Data format for response. | [optional] 
 **callback** | **String** | JSONP | [optional] 
...
```swift
    open class func youtubeLiveChatModeratorsList(liveChatId: String, part: [String], xgafv: Xgafv_youtubeLiveChatModeratorsList? = nil, accessToken: String? = nil, alt: Alt_youtubeLiveChatModeratorsList? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, maxResults: Int? = nil, pageToken: String? = nil, completion: @escaping (_ data: LiveChatModeratorListResponse?, _ error: Error?) -> Void)
```
...
LiveChatModeratorsAPI.youtubeLiveChatModeratorsList(liveChatId: liveChatId, part: part, xgafv: xgafv, accessToken: accessToken, alt: alt, callback: callback, fields: fields, key: key, oauthToken: oauthToken, prettyPrint: prettyPrint, quotaUser: quotaUser, uploadProtocol: uploadProtocol, uploadType: uploadType, maxResults: maxResults, pageToken: pageToken) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
 ...
 **part** | [**[String]**](String.md) | The *part* parameter specifies the liveChatModerator resource parts that the API response will include. Supported values are id and snippet. | 
 **xgafv** | **String** | V1 error format. | [optional] 
 **accessToken** | **String** | OAuth access token. | [optional] 
 **alt** | **String** | Data format for response. | [optional] 
 **callback** | **String** | JSONP | [optional] 
