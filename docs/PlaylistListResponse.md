...
**items** | [Playlist] | A list of playlists that match the request criteria | [optional] 
**kind** | **String** | Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#playlistListResponse\&quot;. | [optional] [default to "youtube#playlistListResponse"]
