//
// LiveChatModeratorListResponse.swift
//
...
public struct LiveChatModeratorListResponse: Codable, Hashable {
    ...
    public init(etag: String? = nil, eventId: String? = nil, items: [LiveChatModerator]? = nil, kind: String? = "youtube#liveChatModeratorListResponse", nextPageToken: String? = nil, pageInfo: PageInfo? = nil, prevPageToken: String? = nil, tokenPagination: AnyCodable? = nil, visitorId: String? = nil) {
        self.etag = etag
