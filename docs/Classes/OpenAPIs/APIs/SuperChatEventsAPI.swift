...
open class SuperChatEventsAPI {
    ...
    open class func youtubeSuperChatEventsListWithRequestBuilder(part: [String], xgafv: Xgafv_youtubeSuperChatEventsList? = nil, accessToken: String? = nil, alt: Alt_youtubeSuperChatEventsList? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, hl: String? = nil, maxResults: Int? = nil, pageToken: String? = nil) -> RequestBuilder<SuperChatEventListResponse> {
        ...
        let requestBuilder: RequestBuilder<SuperChatEventListResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
