...
open class ThumbnailsAPI {
    ...
    open class func youtubeThumbnailsSetWithRequestBuilder(videoId: String, xgafv: Xgafv_youtubeThumbnailsSet? = nil, accessToken: String? = nil, alt: Alt_youtubeThumbnailsSet? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, onBehalfOfContentOwner: String? = nil) -> RequestBuilder<ThumbnailSetResponse> {
        ...
        let requestBuilder: RequestBuilder<ThumbnailSetResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
